...
impl CLI {
    ...
    fn read<AnnotatedT>(&self) -> Result<(Variant<AnnotatedT>, Format), MainError>
    where
    ...
    fn write<AnnotatedT>(&self, content: Variant<AnnotatedT>, input_format: compris::Format) -> Result<(), MainError>
    where
        AnnotatedT: Annotated + Clone + Default,
    {
