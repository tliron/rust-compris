...
impl<W: io::Write> super::super::serializer::Serializer<W> {
    pub fn write_json<V: Serialize>(&mut self, value: &V) -> Result<(), WriteError> {
...
pub struct StyledJsonWriter<W: JsonWriter> {
    writer: W,
}
