...
impl ValueBuilder {
    ...
    /// Starts building a list with metadata.
    ///
    /// Should be followed later by [end_container](Self::end_container).
    ...
    /// Starts building a list with optional coordinates.
    ///
    /// Should be followed later by [end_container](Self::end_container).
    pub fn start_list_with_coordinates(&mut self, coordinates: Option<Coordinates>) {
        self.start_list_with_meta(Meta::new().with_coordinates(coordinates));
    }
    ...
    /// Starts building a map with metadata.
    ///
    /// Should be followed later by [end_container](Self::end_container).
    ...
    /// Starts building a map with optional coordinates.
    ///
    /// Should be followed later by [end_container](Self::end_container).
    pub fn start_map_with_coordinates(&mut self, coordinates: Option<Coordinates>) {
        self.start_map_with_meta(Meta::new().with_coordinates(coordinates));
    }

    /// Starts building a map with an optional annotation.
    ///
    /// Should be followed later by [end_container](Self::end_container).
