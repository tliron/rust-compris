...
impl<R: Read> Reader<R> {
    ...
    pub fn read_yaml(&mut self) -> Result<Value, ReadError> {
        ...
        let mut receiver = YamlReceiver::new(self.try_unsigned_integers, self.allow_legacy, self.allow_legacy);
...
pub struct YamlReceiver {
    ...
    allow_legacy_keywords: bool,
    allow_legacy_binary: bool,
...
impl YamlReceiver {
    /// Constructor.
    pub fn new(allow_unsigned_integers: bool, allow_legacy_keywords: bool, allow_legacy_bytes: bool) -> Self {
        Self {
            allow_unsigned_integers,
            allow_legacy_keywords,
            allow_legacy_binary: allow_legacy_bytes,
    ...
    fn parse_yaml_bare_scalar(&self, value: StdString, location: Location) -> Result<Value, ReadError> {
        ...
        if let Ok(_) = self.parse_yaml_null(&value, &location) {
            ...
            if self.allow_unsigned_integers { Self::parse_yaml_unsigned_integer(&value) } else { None }
        {
