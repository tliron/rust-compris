...
use {kutil_std::error::*, ordermap::*, std::hash::*};

impl<KeyT, ValueT, ContextT, ErrorT> Resolve<OrderMap<KeyT, ValueT>, ContextT, ErrorT> for Value
where
    KeyT: Hash + Eq,
    ...
    ErrorT: ResolveError,
{
    ...
    ) -> ResolveResult<OrderMap<KeyT, ValueT>, ErrorT>
    where
