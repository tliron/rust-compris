...
impl SerializationMode {
    ...
    ///
    /// * [BytesSerializationMode::AsBase64]
    /// * [MapSerializationMode::AsListIfNonStringKey]
    ...
    pub fn for_xjson() -> Self {
        Self {
            integer: IntegerSerializationMode::AsString(Some(XJSON_HINT_INTEGER.into())),
            unsigned_integer: UnsignedIntegerSerializationMode::AsString(Some(XJSON_HINT_UNSIGNED_INTEGER.into())),
            bytes: BytesSerializationMode::AsBase64(Some(XJSON_HINT_BYTES.into())),
            map: MapSerializationMode::AsListIfNonStringKey(Some(XJSON_HINT_MAP.into())),
            ..Default::default()
        }
    }
}
