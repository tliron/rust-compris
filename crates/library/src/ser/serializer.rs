...
impl Serializer {
    ...
    pub fn write_to_file<SerializableT>(&self, value: &SerializableT, path: &path::Path) -> Result<(), SerializeError>
    where
        SerializableT: Serialize,
    {
    ...
    /// Serializes the provided value to the file according to [Serializer::format](Serializer).
    pub fn write_to_stdout<SerializableT>(&self, value: &SerializableT) -> Result<(), SerializeError>
    where
        SerializableT: Serialize,
    {
    ...
    /// Serializes the provided value to the file according to [Serializer::format](Serializer).
    pub fn write_to_stdout_modal(&self, value: &Value, mode: &SerializationMode) -> Result<(), SerializeError> {
        let value = value.modal(mode, self);
        self.write_to_stdout(&value)
    }
