            ...
            if attributes_have_ident(&field.attrs, "resolve") {
                ...
                if field_attribute.other_keys {
                    if generator.other_keys_field.is_some() {
                        ...
                        generator.other_keys_field =
                            Some(Field { name: field_name.to_token_stream(), attribute: field_attribute.clone() });
                        continue;
                    }
                }
                ...
                generator
                    .resolve_fields
                    .push((Field { name: field_name.to_token_stream(), attribute: field_attribute }, key.clone()));
