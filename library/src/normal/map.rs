...
impl<AnnotatedT> From<Map<AnnotatedT>> for BTreeMap<Variant<AnnotatedT>, Variant<AnnotatedT>> {
...
impl<'own, AnnotatedT> From<&'own Map<AnnotatedT>> for &'own BTreeMap<Variant<AnnotatedT>, Variant<AnnotatedT>> {
